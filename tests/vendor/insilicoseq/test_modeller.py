...
from marbel.vendor.insilicoseq import bam, modeller


def test_kde_qualities():
    quality_distribution = [[40, 30], [40, 30], [20, 20], [40, 10], [10, 10]]
...
def test_substitutions():
    ...
    bam_file = "tests/vendor/insilicoseq/data/substitutions_test.bam"
...
def test_indels():
    ...
    insertion, deletion = modeller.indel_matrix_to_choices(indel_matrix, 20)
